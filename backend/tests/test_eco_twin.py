...
def test_basic_prediction():
    recs = [Recommendation(title="T1", description="D1", co2_savings_kg=50, cost_savings_inr=100, difficulty="easy")]
...
def test_prediction_never_negative():
    recs = [Recommendation(title="T1", description="D1", co2_savings_kg=300, cost_savings_inr=100, difficulty="easy")]
    res = calculate_eco_twin(200, recs)
